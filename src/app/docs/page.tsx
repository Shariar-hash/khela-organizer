...
1. Enter your phone number (e.g., 01712345678)
2. Click "Login"
3. If you're new, enter your name to register
4. You're logged in!

It's that simple - no password needed!`,
        },
        {
          icon: Trophy,
...
১. আপনার ফোন নম্বর দিন (যেমন, ০১৭১২৩৪৫৬৭৮)
২. "লগইন" ক্লিক করুন
৩. নতুন হলে, রেজিস্টার করতে আপনার নাম দিন
৪. লগইন সম্পন্ন!

এটাই সব - কোন পাসওয়ার্ড লাগবে না!`,
        },
        {
          icon: Trophy,
